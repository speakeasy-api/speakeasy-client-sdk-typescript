...
- [`eventsGetTargetsSummary`](docs/sdks/events/README.md#gettargetssummary) - Load a lean summary of targets for a workspace with pagination. Returns only essential fields needed by the dashboard UI.
...
- [`useEventsGetTargetsSummary`](docs/sdks/events/README.md#gettargetssummary) - Load a lean summary of targets for a workspace with pagination. Returns only essential fields needed by the dashboard UI.
