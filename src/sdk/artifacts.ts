...
export class Artifacts extends ClientSDK {
    ...
    async getBlob(
        ...
        return unwrapAsync(artifactsGetBlob(this, request, options));
    }
    ...
    async getManifest(
        ...
        return unwrapAsync(artifactsGetManifest(this, request, options));
    }
    ...
    async getOASSummary(
        ...
        return unwrapAsync(artifactsGetOASSummary(this, request, options));
    }
    ...
    async getRevisions(
        ...
        return unwrapAsync(artifactsGetRevisions(this, request, options));
    }
    ...
    async getTags(
        ...
        return unwrapAsync(artifactsGetTags(this, request, options));
    }
    ...
    async postTags(
        ...
        return unwrapAsync(artifactsPostTags(this, request, options));
    }
