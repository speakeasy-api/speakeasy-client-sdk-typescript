...
export class Schemas extends ClientSDK {
    ...
    async deleteSchema(
        ...
        return unwrapAsync(schemasDeleteSchema(this, request, options));
    }
    ...
    async downloadSchema(
        ...
        return unwrapAsync(schemasDownloadSchema(this, request, options));
    }
    ...
    async downloadSchemaRevision(
        ...
        return unwrapAsync(schemasDownloadSchemaRevision(this, request, options));
    }
    ...
    async getSchema(
        ...
        return unwrapAsync(schemasGetSchema(this, request, options));
    }
    ...
    async getSchemaDiff(
        ...
        return unwrapAsync(schemasGetSchemaDiff(this, request, options));
    }
    ...
    async getSchemaRevision(
        ...
        return unwrapAsync(schemasGetSchemaRevision(this, request, options));
    }
    ...
    async getSchemas(
        ...
        return unwrapAsync(schemasGetSchemas(this, request, options));
    }
    ...
    async registerSchema(
        ...
        return unwrapAsync(schemasRegisterSchema(this, request, options));
    }
}
