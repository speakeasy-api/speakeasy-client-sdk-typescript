...
export class GetEmbedAccessTokenQueryParams {
    ...
    constructor(Description?: string, Duration?: number, Filters?: shared.Filters) {
...
export class GetEmbedAccessTokenResponse {
    ...
    constructor(ContentType: string, StatusCode: number, EmbedAccessTokenResponse?: shared.EmbedAccessTokenResponse, Error?: shared.Error) {
