...
export type QueryEventLogResponse = shared.ErrorT | Array<shared.BoundedRequest>;
...
export const QueryEventLogResponse$inboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    unknown
> = z.union([shared.ErrorT$inboundSchema, z.array(shared.BoundedRequest$inboundSchema)]);
...
export const QueryEventLogResponse$outboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    QueryEventLogResponse
> = z.union([shared.ErrorT$outboundSchema, z.array(shared.BoundedRequest$outboundSchema)]);
