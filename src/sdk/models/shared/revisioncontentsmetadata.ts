...
import {
  Server,
  Server$inboundSchema,
  Server$Outbound,
  Server$outboundSchema,
} from "./server.js";
...
> = z.object({
  ...
  server_urls: z.array(Server$inboundSchema),
...
export type RevisionContentsMetadata$Outbound = {
  ...
  server_urls: Array<Server$Outbound>;
  tags: Array<string>;
  title: string;
  type: string;
  version: string;
...
> = z.object({
  ...
  serverUrls: z.array(Server$outboundSchema),
  tags: z.array(z.string()),
  title: z.string(),
