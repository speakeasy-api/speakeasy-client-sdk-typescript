...
/** @internal */
export const AccountType$inboundSchema: z.ZodType<AccountType, z.ZodTypeDef, unknown> = z.union([
    z.nativeEnum(AccountType),
    z.string().transform(catchUnrecognizedEnum),
]);

/** @internal */
export const AccountType$outboundSchema: z.ZodType<AccountType, z.ZodTypeDef, AccountType> =
