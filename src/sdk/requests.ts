...
export class Requests extends ClientSDK {
    ...
    async generateRequestPostmanCollection(
        ...
        return unwrapAsync(requestsGenerateRequestPostmanCollection(this, request, options));
    }
    ...
    async getRequestFromEventLog(
        ...
        return unwrapAsync(requestsGetRequestFromEventLog(this, request, options));
    }
    ...
    async queryEventLog(
        ...
        return unwrapAsync(requestsQueryEventLog(this, request, options));
    }
}
