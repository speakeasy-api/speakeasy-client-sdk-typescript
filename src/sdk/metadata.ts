...
export class Metadata extends ClientSDK {
    ...
    async deleteVersionMetadata(
        ...
        return unwrapAsync(metadataDeleteVersionMetadata(this, request, options));
    }
    ...
    async getVersionMetadata(
        ...
        return unwrapAsync(metadataGetVersionMetadata(this, request, options));
    }
    ...
    async insertVersionMetadata(
        ...
        return unwrapAsync(metadataInsertVersionMetadata(this, request, options));
    }
}
