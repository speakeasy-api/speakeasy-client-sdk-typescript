 ...
 */
export function organizationsActivateLanguage(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ActivateLanguageRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/organization/languages/{language}/activate")(
    pathParams,
  );
