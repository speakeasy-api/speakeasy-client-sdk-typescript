 ...
 */
export function organizationsCancelSubscription(
...
> {
  const parsed = safeParse(
    request,
    (value) => shared.CancelSubscriptionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/organization/billing/subscription/cancel")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json("2XX", shared.CancelSubscriptionResponse$inboundSchema),
