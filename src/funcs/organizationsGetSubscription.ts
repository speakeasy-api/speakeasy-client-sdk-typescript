 ...
 */
export function organizationsGetSubscription(
...
> {
  const path = pathToFunc("/v1/organization/billing/subscription")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json("2XX", shared.OrganizationSubscriptionResponse$inboundSchema),
