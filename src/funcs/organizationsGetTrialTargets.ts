 ...
 */
export function organizationsGetTrialTargets(
  client: SpeakeasyCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    shared.TrialTargetsResponse,
    | errors.ErrorT
    | SpeakeasyError
...
> {
  const path = pathToFunc("/v1/organization/billing/trial_targets")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json("2XX", shared.TrialTargetsResponse$inboundSchema),
